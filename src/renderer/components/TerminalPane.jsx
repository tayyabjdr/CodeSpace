...
export default function TerminalPane({ id, ptyId, shell, cwd, workspaceDir, agentNum, name, branch, fontSize, onClose, onFocus, onRename, onPtyReady, onFontSizeChange, onAddAgent, onSwap, onOpenFile, isFocused }) {
